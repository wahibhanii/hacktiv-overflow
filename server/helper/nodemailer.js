              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi ${notifInfo.question.author.userName},</p>
                        <p><b>${notifInfo.answerer.userName}</b> has answered your question</p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://hackflow.wahibhanii.xyz/#/article/${notifInfo.question._id}" target="_blank">Go to page</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>${notifInfo.answerer.userName}'s anwer: <br>
                        ${notifInfo.answerContent}</p>
                        <p>Thank you..</p>
                      </td>
                    </tr>
                  </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">HacktivOverflow, Jakarta, Indonesia</span>
